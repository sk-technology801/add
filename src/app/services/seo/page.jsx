        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                {['Digital Marketing', 'Web Development', 'Mobile Apps', 'Brand Design', 'Analytics & Insights', 'Cloud Solutions'].map((service, index) => (
                  <li key={index}>
                    <Link
                      href="/services"
                      className="text-gray-400 hover:text-blue-400 transition-colors text-sm"
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>Email: <a href="mailto:info@adsen.com" className="hover:text-blue-400">info@adsen.com</a></li>
          ...
          <div className="mt-12 pt-8 border-t border-gray-700 text-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} Adsen. All rights reserved.
            </p>
          </div>
        </div>
      </footer>
