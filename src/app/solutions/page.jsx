          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 text-sm">
                <li>
                  Email: <a href="mailto:info@adsen.com" className="hover:text-orange-400">info@adsen.com</a>
                </li>
                <li>
                  Phone: <a href="tel:+1234567890" className="hover:text-orange-400">+1 (234) 567-890</a>
                </li>
